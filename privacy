...
Because we do not collect your personal data, we do not share, sell, or trade any user information with third-party networks, advertisers, or analytics providers.

## 4. Data Retention and Deletion
All app data is tied directly to your local device installation. You can permanently delete all data (such as your saved alarms and configurations) simply by clearing the App's data in your Android settings or by uninstalling Any Alarm from your device.

## 5. Children's Privacy
Any Alarm does not knowingly collect personally identifiable information from children. Since the app does not transmit personal data externally, children's data is inherently protected on the device.
